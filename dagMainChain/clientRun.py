        ...
        while (currentEpoch <= args.epochs):
            ...
            for deviceID in deviceSelected:
                ...
                if not os.path.exists(localFileName):
                    print(f"Warning: Model file not found for {deviceID} (lazy node or timeout)")
                    continue
            ...
            nodeTestLossDf.to_csv("../data/result/{}_loss.csv".format(filename_base), index=False, sep=',')
            ...
            nodeTrainAccDf.to_csv("../data/result/{}_train.csv".format(filename_base), index=False, sep=',')

            nodeTrainLossDf = pd.DataFrame({'shard_{}'.format(nodeNum):nodeTrainLoss})
            nodeTrainLossDf.to_csv("../data/result/{}_train_loss.csv".format(filename_base), index=False, sep=',')
